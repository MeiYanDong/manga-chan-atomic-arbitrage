...
test('systemd unit keeps the board in a separate loopback-only identity without credentials', () => {
  ...
  assert.match(example, /^MANGA_BOARD_EVENT_V4_PAIR_LIMIT=2$/m)
